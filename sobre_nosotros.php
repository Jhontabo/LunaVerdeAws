        ...
        <div class="container">
            ...
            <div class="collapse navbar-collapse" id="navbarSupportedContent">
                <ul class="navbar-nav mx-auto">
                    ...
                    <li class="nav-item px-lg-4"><a class="nav-link text-uppercase" href="cafeteria.php">Cafeteria</a></li>
    ...
    <section class="page-section">
        <div class="container">
            <div class="product-item">
                ...
                <img class="product-item-img mx-auto d-flex rounded img-fluid mb-3 mb-lg-0" src="https://cdn.pixabay.com/photo/2017/01/26/02/06/platter-2009590_1280.jpg" alt="..." />
                <div class="product-item-description d-flex me-auto">
                    <div class="bg-faded p-5 rounded">
                        <p class="mb-0"><?php echo $descripcion[2]; ?></p>
                    </div>
                </div>
            </div>
        </div>
    ...
    <section class="page-section">
        <div class="container">
            <div class="product-item">
                ...
                <img class="product-item-img mx-auto d-flex rounded img-fluid mb-3 mb-lg-0" src="https://cdn.pixabay.com/photo/2016/03/27/21/34/restaurant-1284351_960_720.jpg" alt="..." />
                <div class="product-item-description d-flex ms-auto">
                    <div class="bg-faded p-5 rounded">
                        <p class="mb-0"><?php echo $descripcion[3]; ?></p>
                    </div>
                </div>
            </div>
        </div>
